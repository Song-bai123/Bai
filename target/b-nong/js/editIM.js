	...
	$("body").on("click",".add-ds",function(){
		if(i<26){
			...
			$(".add-con").append("<li class='edittable-bottom'>" +
				"<div class='editbottom-left'>产毒菌株信息"+delcharacter[0]+"</div>" +
				"<div class='editbottom-right'>" +
				"<ul>" +
				"<li>" +
				"<lable>样品编号</lable>" +
				...
				"<lable>图片信息</lable>" +
				"<a class='xz-btn-b'>选择文件</a> " +
				"<input type='text' name='pictureAddr' id='' value='' class='file-name-b' readonly='readonly' placeholder='仅支持jpg/png格式图片'/>" +
				"<input onchange='getPhotoSize(this)' name='picture_addr' type='file' class='file-info-b' accept='.png,.jpg,.jpeg'/>" +
				"</li>" +
				"<li>" +
				"<a class='del'>删除</a>" +
